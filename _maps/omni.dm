...
*/
        ...
        #include "map_files\omni\omni.dmm"
        #include "map_files\omni\z2.dmm"
        #include "map_files\omni\z3.dmm"
        #include "map_files\omni\z4.dmm"
        #include "map_files\omni\z5.dmm"
        #include "map_files\omni\z6.dmm"
        #include "map_files\omni\z7.dmm"

        #define MAP_FILE "omni.dmm"
        #define MAP_NAME "NSS Thea"
